...
const ClientsOrderToolbar = (props) => {
          ...
          <Grid item lg={9} md={9} xl={9} xs={12}>
            ...
            >
              ...
              <Button
                activeClassName={classes.active}
                className={classes.button}
                onClick={props.searchClientCancelled}
              >
                Cancelled By Client
              </Button>
              <Button
                activeClassName={classes.active}
                className={classes.button}
                onClick={props.searchBuilderCancelled}
              >
...
ClientsOrderToolbar.propTypes = {
  className: PropTypes.string,
};

export default ClientsOrderToolbar;
